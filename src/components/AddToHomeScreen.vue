<template>
    <div v-if="display" id="install" :style="style">
        Install this web app on your mobile for the best experience. It's easy, just tap
        <img id="share" class="inline mx-2" :src="`data:image/png;base64,${iOSShareBase64}`"> and then "Add to Home Screen".
        <div id="arrowOuter"></div>
        <div id="arrowInner"></div>
        <img class="absolute bottom-2" id="close" @click="closeClick" :src="`data:image/png;base64,${closeBase64}`">
    </div>
</template>
